...
const PT = {
  ...
  errorCodes: {
    ...
    'learn.insightStartsWithDelimiter': 'insight não pode começar com o delimitador de frontmatter `---`',
    'learn.badDomain': 'domínio inválido: {problem}',
    'learn.unknownDomain': "domínio '{dominio}' não existe em 02-wiki/. Domínios válidos: {validos}. Repita com confirm_novo_dominio para criar.",
    ...
    'relocate.newDomainNeedsConfirm': '{toDomain} ainda não tem MOC em 02-wiki/; passe confirm_novo_dominio para criar.',
    ...
    'relocate.noHeadVersion': '{relPath} não tem versão commitada no HEAD, então apagá-la é irreversível',
    'relocate.hasBacklinks': '{count} nota(s) apontam para {relPath} e os links ficarão quebrados',
    'template.unresolvedToken': 'token Templater não resolvido (forma não suportada, possivelmente multi-linha): {fragment}',
...
const EN: Messages = {
  ...
  errorCodes: {
    ...
    'learn.insightStartsWithDelimiter': 'insight cannot start with the frontmatter delimiter `---`',
    ...
    'relocate.noHeadVersion': '{relPath} has no committed version in HEAD, so deleting it is irreversible',
    'relocate.hasBacklinks': '{count} note(s) point at {relPath} and their links will break',
    'template.unresolvedToken': 'unresolved Templater token (unsupported shape, possibly multi-line): {fragment}',
